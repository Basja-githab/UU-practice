...
# user_name.send_keys(Keys.BACKSPACE)             # и удаляет выделенное

#sleep(2)
#driver.execute_script("window.scrollTo(0, 300);") # скроллинг по координатам

# action = ActionChains(driver)
# element = driver.find_element(By.XPATH, '//*[@id="page_wrapper"]/footer/div')
# action.move_to_element(element).perform()        # перемещение к найденному элементу
